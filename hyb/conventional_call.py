...
def uid_based_call(WD,input, sample, target_info,threads, min_base_ratio):
	...
	run_multi(thread_function, threads, pair_dedup, WD, input,sample, target_info, min_base_ratio, other_args=(idTOpair,))
	out_df=pd.DataFrame()
